...
// The raymarch step count is fixed in-shader (`++i < 60.0`); the real
// iterations knob is uQuality/uStepScale below - this param is vestigial
// in the pasted source but left as-is.
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      try {
        ...
        // Best-effort teardown - nothing to recover from here.
      }
    };
